...
export default function Login() {
    ...
    const changeState = (state: boolean) => { // true -> login ; false -> register
        setLoginActive(state)
    }
    return (
        <section className="relative flex min-h-screen bg-[#f7f7f7] dark:bg-transparent transition-all">
            <div className={`flex-col flex-1 justify-center transition-all duration-300 ${!loginActive ? 'w-0 -translate-x-full' : 'flex translate-x-0 w-1/3'}`}>
                <div className="w-full max-w-xl mx-auto lg:w-96">
                    ...
                    <div className="mt-8">
                        <div className="mt-6">
                            <form id="form" className="space-y-6" onSubmit={handleLogin}>
                                <div>
                                    <label
                                ...
                                <div className="flex items-center">
                                    <p className="dark:text-gray-200 mr-3">No tienes cuenta?</p>
                                    <div className="text-sm">
                                        <a className="font-medium text-blue-600 hover:text-blue-500" href="#registro" onClick={() => changeState(false)}>
                                            Crea tu cuenta
                                        </a>
                                    </div>
                                </div>
            ...
            <div className="w-2/3 hidden lg:block relative">
                <Image
                    ...
                    width="1260"
                    height="720"
                    style={{ aspectRatio: 1260 / 720, objectFit: "cover" }}
                />
            </div>
            <PanelRegistro loginActive={loginActive} setLoginActive={setLoginActive} />
        </section>
    );
}